            ...
            (function () {
              ...
              const J = {
                  ...
                  labels: {
                    ...
                    perPage: "عدد الفواتير المعروضة",
                    pageTitle: "Page {page}",
                    noRows: "لا توجد فواتير للعرض",
                    noResults: "لا توجد نتائج تطابق استعلام البحث الخاص بك",
                    info: "عرض من {start} الى {end} فاتورة من اجمالي {rows} فاتورة",
                  },
                  template: (t, e) =>
                    `<div class='${t.classes.top}'>\n    ${
                      t.paging && t.perPageSelect
                        ? `<div class='${t.classes.dropdown}'>\n            <label>\n               ${t.labels.perPage} <select class='${t.classes.selector}'></select> \n            </label>\n        </div>`
                        : ""
                    }\n    ${
                      t.searchable
                        ? `<div class='${
